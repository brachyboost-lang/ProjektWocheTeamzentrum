...
{
    public class RaceACC : Race
    {
        public RaceACC(List<CarClass> carClasses, string track, int simulationType, int maximumParticipants,
            ...
            : base(carClasses, track, 2, maximumParticipants, driversPerCar,
